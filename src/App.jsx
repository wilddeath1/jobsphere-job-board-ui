...
const App = () => {
  const jobOpenings = [
    ...
    },
    {
      ...
      apply: "https://www.apple.com/careers/"
    },
    {
    ...
    {
      brandLogo: "https://img.icons8.com/color/1200/google-logo.jpg",
      companyName: "Google",
    ...
    },
    {
      ...
      apply: "https://www.nvidia.com/en-us/about-nvidia/careers/"
    },
    {
    ...
    <>
      ...
      <div className='parent'>
        {jobOpenings.map(function (elem, idx) {
          return <div key={idx}>
            <Card brandLogo={elem.brandLogo} companyName={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location} apply={elem.apply} />
          </div>
        })}
      </div>
    </>
